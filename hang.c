...
void game_title(int foreground_color) {
  ...
  mvprintw(y,   x, "H    H     A     N      N    GGGGG   M M     M M     A     N      N");
  mvprintw(y+1, x, "H    H   A   A   N N    N   G     G  M  M   M  M   A   A   N N    N");
  mvprintw(y+2, x, "H    H  A     A  N  N   N   G        M   M M   M  A     A  N  N   N");
  mvprintw(y+3, x, "HHHHHH  AAAAAAA  N   N  N   G   GGG  M    M    M  AAAAAAA  N   N  N");
  mvprintw(y+4, x, "H    H  A     A  N    N N   G     G  M         M  A     A  N    N N");
  mvprintw(y+5, x, "H    H  A     A  N     NN   G     G  M         M  A     A  N     NN");
  mvprintw(y+6, x, "H    H  A     A  N      N    GGGGG   M         M  A     A  N      N");
...
void top_right_menu(void) {
  
  printw("\t\tPause: Press [\t\tQuit: Press ]\n");
